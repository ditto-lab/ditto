...
contract FloorTest is TestBase {
    ...
    function testFloorCloneSetsNewClonePrice() public {
        ...
        (uint floorId, /*uint flotoId*/) = dm.duplicate(nftAddr, FLOOR_ID, currencyAddr, MIN_AMOUNT_FOR_NEW_CLONE * 2, true, 0);
        vm.stopPrank();
        ...
        (uint cId, /*uint flotoId*/) = dm.duplicate(nftAddr, nftId, currencyAddr, MIN_AMOUNT_FOR_NEW_CLONE * 2, false, 0);
    ...
    function testFloorCloneSetsExistingClonePrice() public {
        ...
        (uint floorId, /*uint protoId*/) = dm.duplicate(nftAddr, FLOOR_ID, currencyAddr, MIN_AMOUNT_FOR_NEW_CLONE * 3, true, 0);
        vm.stopPrank();
    ...
    function testFloorSellUnderlyingForFloor() public {
        ...
        (uint cloneId1, ) = dm.duplicate(nftAddr, FLOOR_ID, currencyAddr, MIN_AMOUNT_FOR_NEW_CLONE, true, 0);
    ...
    function testFloorSellUnderlyingForCloneWhileFloorExists() public {
        ...
        (uint floorId, /*uint flotoId*/) = dm.duplicate(nftAddr, FLOOR_ID, currencyAddr, MIN_AMOUNT_FOR_NEW_CLONE, true, 0);
        vm.stopPrank();
    ...
    function testFloorSellUnderlyingForFloorWithCheaperClone() public {
        ...
        (uint floorId, /*uint protoId*/) = dm.duplicate(nftAddr, FLOOR_ID, currencyAddr, MIN_AMOUNT_FOR_NEW_CLONE * 2, true, 0);
        vm.stopPrank();
    ...
    function testFloorSellUnderlyingForCloneWithCheaperFloor() public {
        ...
        (uint cloneId, /*uint protoId*/) = dm.duplicate(nftAddr, nftId, currencyAddr, MIN_AMOUNT_FOR_NEW_CLONE * 2, false, 0);
        vm.stopPrank();
