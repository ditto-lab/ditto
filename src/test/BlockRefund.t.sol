...
contract BlockRefundTest is TestBase {
    ...
    function testRefund() public {
        ...
        for (uint128 i = 0; i<10; ++i) {
            ...
            (uint cloneId, ) = dm.duplicate(nftAddr, nftId, currencyAddr, MIN_AMOUNT_FOR_NEW_CLONE * (i+1), false, 0);
    ...
    function testRefundFuzz(uint128 amount0, uint128 amount1) public {
        ...
        (uint cloneId, ) = dm.duplicate(nftAddr, nftId, currencyAddr, amount0, false, 0);
    ...
    function testRefundSelf() public {
        ...
        (uint cloneId, ) = dm.duplicate(nftAddr, nftId, currencyAddr, MIN_AMOUNT_FOR_NEW_CLONE, false, 0);
    ...
    function testRefundSelfFuzz(uint128 amount) public {
        ...
        // open initial clone position
        (uint cloneId, ) = dm.duplicate(nftAddr, nftId, currencyAddr, amount, false, 0);
